...
def main(args):
    ...
    train_transforms, test_transforms = utils.bring_data_transformation_cifar()
    ...
    src_train_dset, _, _ = src_dset.get_dsets_cifar()
    ...
    from models.model_ACRE import ACRE
    model = ACRE(args, num_class, src_dset, target_dset, test_transforms)


    model.train_init_ours()
    model.train_load_model()

    auroc, aupr, fprs, detection = model.OODtest(score=args.OOD_Score)
