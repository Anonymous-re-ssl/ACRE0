...
class Classifier(MetaModule):
    def __init__(self, in_node, num_classes):
        ...
        self.fc = MetaLinear(in_node, num_classes)
...
class SimCLR(MetaModule):
    def __init__(self, backbone, fc):
        ...
        self.linear1 = MetaLinear(dim_mlp, dim_mlp)
...
class WNet2(MetaModule):
    def __init__(self, input, output):
        super(WNet2, self).__init__()
        self.linear1 = MetaLinear(input, output)
