...
## Model Level
parser.add_argument('--model', type=str, default='ACRE')
...
parser.add_argument('--lambda_G', type=float, default=0.5,
                    help='coefficient for loss_G')
parser.add_argument('--lambda_ent_Ctk', type=float, default=0.5,
                    help='coefficient for loss_ent_Ctk')
parser.add_argument('--lambda_cls_Ctu', type=float, default=0.2,
                    help='coefficient for loss_cls_Ctu')
parser.add_argument('--OOD_Score', type=str, default='K+1',
                    help='OOD Score for OOD detection')
